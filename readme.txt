=== Facebook Likebox Slider SoSlider ===
...
1. Login to WordPress admin panel, go to 'Plugins', next click 'Add New', choose 'Upload', click 'Browse' and find a lite-sosoft-soslider.zip and next click 'Upload Now'
